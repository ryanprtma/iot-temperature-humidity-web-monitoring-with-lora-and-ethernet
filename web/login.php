  ...
  if( mysqli_num_rows($result) === 1)
  {
    ...
    if ( password_verify($password, $row["password"]) )
    {
      ...
      if( isset($_POST["remember"]) )
      {
        ...
        setcookie('key', hash('sha256', $row['username']), time()+3600); // hash adalah teknik mengacak
      }
      header("Location: index.php");
      exit;
    }
...
<html lang="en">
  ...
  <div class="text-center mb-4">
    ...
    <p>Silahkan masukkan username dan password anda, sebelum masuk ke dalam sistem </p>
    <?php if( isset($error) ) : ?>
  ...
  <div>
    <p style="text-align: left;">Tidak punya akun? <span><a href="registrasi.php">Buat akun</a></span></p>
  </div>
